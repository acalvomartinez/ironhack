...
- (void)setXDisplacement:(CGFloat)xDisplacement {
    ...
    [self setXDisplacement:xDisplacement animated:NO];
}
...
- (void)setXDisplacement:(CGFloat)xDisplacement animated:(BOOL)animated {
    ...
    pathAnimation.values = @[
                             (id)[self shapeWithControlPoint:CGPointMake(xDisplacement - 20, 0)].CGPath,
                             (id)[self shapeWithControlPoint:CGPointMake(xDisplacement + 8, 0)].CGPath,
                             (id)[self shapeWithControlPoint:CGPointMake(xDisplacement - 8, 0)].CGPath,
                             (id)[self shapeWithControlPoint:CGPointMake(xDisplacement - 4, 0)].CGPath,
                             (id)[self shapeWithControlPoint:CGPointMake(xDisplacement - 0, 0)].CGPath];
