...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    _fetchedResultsController = [self fetchedResultsControllerWithFetchRequest:fetchRequest withSectionNameKeyPath:@"user"];
